...
typedef SWIFT_ENUM(NSInteger, MiSnapUxpEvent, open) {
  ...
  MiSnapUxpEventRestartPollingVerbose = 38,
  MiSnapUxpEventUnknownTagVerbose = 39,
  MiSnapUxpEventPaceSupportVerbose = 40,
  MiSnapUxpEventCaSupportVerbose = 41,
  MiSnapUxpEventAaSupportVerbose = 42,
  MiSnapUxpEventAccessMechanismVerbose = 43,
  MiSnapUxpEventDiscardVerbose = 44,
  MiSnapUxpEventCancelVerbose = 45,
  MiSnapUxpEventCancel = 46,
  MiSnapUxpEventInstruction = 47,
  MiSnapUxpEventHelp = 48,
  MiSnapUxpEventTimeout = 49,
  MiSnapUxpEventReview = 50,
  MiSnapUxpEventMeasuredConfidence = 51,
  MiSnapUxpEventMeasuredCornerPoints = 52,
  MiSnapUxpEventMeasuredMicrConfidence = 53,
  MiSnapUxpEventMeasuredContrast = 54,
  MiSnapUxpEventMeasuredBackground = 55,
  MiSnapUxpEventMeasuredAngle = 56,
  MiSnapUxpEventMeasuredRotationAngle = 57,
  MiSnapUxpEventMeasuredSharpness = 58,
  MiSnapUxpEventMeasuredBrightness = 59,
  MiSnapUxpEventMeasuredGlare = 60,
  MiSnapUxpEventMeasuredWidth = 61,
  MiSnapUxpEventMeasuredAutoTime = 62,
  MiSnapUxpEventMeasuredManualTime = 63,
  MiSnapUxpEventMeasuredFailover = 64,
  MiSnapUxpEventTorchOn = 65,
  MiSnapUxpEventTorchOff = 66,
  MiSnapUxpEventStartAuto = 67,
  MiSnapUxpEventStartManual = 68,
  MiSnapUxpEventOrientationLandscape = 69,
  MiSnapUxpEventOrientationPortrait = 70,
};
