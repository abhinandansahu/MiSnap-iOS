...
/// Layout
@property (nonatomic) enum MiSnapFacialCaptureTutorialButtonLayout layout SWIFT_DEPRECATED_MSG("Starting with 5.10.0 the only supported layout is vertical which is needed to support Larger Text for compliance with accessibility regulation");
